const exitEdit = (a: any) => ({type: "dummy"}); const setCodeToEdit = (a: any) => ({type: "dummy"}); const enterEdit = (a: any) => ({type: "dummy"}); type OnboardingModes = any;
...
const useOnboardingCard = () => ({ open: (s?: any) => {} });
